...
folder_path = '/mnt/6a35bb5c-3c75-400e-a2fa-146fee20967e/home/fcssaleh/ICWT/BCH_127_99'
Parity_Check_Matrix = np.load(folder_path+'/test_data/H_BCH_127_99.npy')
...
w = np.array([[h[j] for _ in range(batch_size)] for j in range(gragh_edge)] )
...
folder_path = '/mnt/6a35bb5c-3c75-400e-a2fa-146fee20967e/home/fcssaleh/ICWT/BCH_127_99'
code_generatorMatrix = np.load(folder_path+'/test_data/G_BCH_127_99.npy')
...
batches_for_val = 2*np.array([2,2,4,15,20,50,150,300])
batch_in_epoch = 1000
...
with tf.Session() as sess:
    ...
    for i in range(num_of_batch):                
        ...
        if(i%batch_in_epoch == 0):
            ...
            pltf.grid(True)
            pltf.savefig('N3_127_99_sum_of_BER.png')
            pltf.close()
