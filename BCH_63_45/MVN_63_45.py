...
folder_path = '/mnt/6a35bb5c-3c75-400e-a2fa-146fee20967e/home/fcssaleh/ICWT/BCH_63_45'
Parity_Check_Matrix = np.load(folder_path+'/test_data/BCH_63_45_PCM.npy')
...
folder_path = '/mnt/6a35bb5c-3c75-400e-a2fa-146fee20967e/home/fcssaleh/ICWT/BCH_63_45'
code_generatorMatrix = np.load(folder_path+'/test_data/BCH_63_45_GM.npy')
...
hidden_19_layer = {'weights':tf.Variable(v1),'biase':tf.Variable(biase_sc)}
hidden_19_layer['weights'] = tf.multiply(v1,hidden_19_layer['weights'])
hidden_19_layer['biase'] = tf.multiply(biase_sc,hidden_19_layer['biase'])
l19 = tf.add(tf.matmul(l15, hidden_19_layer['weights']),tf.matmul(x,hidden_19_layer['biase']))
l19 = tf.tanh(0.5 * l19)
    
l10 = tf.multiply(c2,l19)
l10 = l10 + _w2
...
with tf.Session() as sess:
    ...
    for i in range(num_of_batch):  
        ...
        if(i%batch_in_epoch == 0):
            ...
            pltf.grid(True)
            pltf.savefig('N29_63_45_sum_of_BER.png')
            pltf.close()
